...
<head>
    ...
    <style>
        ...
        .info-box { width: 48%; }
        .info-box h3 { font-size: 16px; margin-bottom: 10px; color: #3B82F6; border-bottom: 2px solid #E5E7EB; padding-bottom: 5px; }
        ...
        .grand-total { font-size: 18px; color: #3B82F6; font-weight: bold; border-top: 2px solid #3B82F6; padding-top: 10px; margin-top: 10px; }
